...
import slide1 from "../../../app/assets/img/images/mobile_screen_1.png";
import slide2 from "../../../app/assets/img/images/mobile_screen_2.png";
...
const DownloadApp = () => {
  return (
    <section className="booking__downloadapp relative" id="appDownLoad">
      ...
      <div className="downloadapp__bg absolute top-0 bottom-0 w-full"></div>
    </section>
  );
};
